...
const FinalBookingSummary = ({
  ...
  // differenceInCalendarDays trả về số ngày trọn vẹn, có thể cần +1 nếu tính cả ngày check-out
  // Tuy nhiên, logic tính số đêm thường là ngày trả phòng - ngày nhận phòng.
    ...
    <div className="bg-white border-gray-200 border rounded-lg p-6 mb-6 shadow w-full max-w-lg mx-auto mt-4">
      <div className="mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-3">
          <div>
            <p className="text-sm font-semibold text-gray-600">Nhận phòng</p>
          ...
          <div>
            <p className="text-sm font-semibold text-gray-600">Trả phòng</p>
