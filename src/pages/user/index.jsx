...
import Tabs from 'components/share/tabs/Tabs';
import TabPanel from 'components/share/tab-panel/TabPanel';
import {
  faAddressCard,
  faHotel,
  faCreditCard,
    ...
    <>
      <div className="container mx-auto p-4 my-10 min-h-[530px]">
        ...
        <Tabs isTabsVisible={isTabsVisible} wrapperRef={wrapperRef}>
          ...
          <TabPanel label="Chi tiết thanh toán" icon={faCreditCard}>
            <PaymentMethodsPanel
